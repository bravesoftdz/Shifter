...
type
  TScoreDialog = class(TForm)
    ...
    OKButton: TButton;
    ResetRecordsButton: TButton;
    ActionList: TActionList;
    OKAction: TAction;
    ResetRecordsAction: TAction;
    procedure FormDestroy(Sender: TObject);
    procedure ResetRecordsActionExecute(Sender: TObject);
...
uses
  Common, YourName, BigIni, Vcl.Themes;
...
procedure TScoreDialog.OKActionExecute(Sender: TObject);
begin
  WriteIniFile;
  ModalResult := mrOk;
end;
