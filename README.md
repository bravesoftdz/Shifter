A very addictive puzzle game. Basic idea is to continuously reverse two blocks so that atleast three same colored blocks will be vertically or horizontally next to each other.
